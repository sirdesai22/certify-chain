...
import { Shield, Wallet, ArrowLeft, GraduationCap } from "lucide-react";
        ...
        <Card className="w-full max-w-md mx-auto">
          <CardHeader className="w-full">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <GraduationCap className="text-primary w-14 h-14" />
              </div>
              ...
              <CardDescription className="text-center leading-relaxed">
                Sign in with your student Google account to securely access the platform.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
